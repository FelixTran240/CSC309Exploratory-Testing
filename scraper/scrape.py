...
url_items = "http://localhost:3000/api/items/"
url_location = "http://localhost:3000/api/locations/"
url_venue = "http://localhost:3000/api/venues/util/getByName/"
...
# 1901: ID = 1
get_foods_again("1901 Marketplace", driver, "Tuesday, February 19")
